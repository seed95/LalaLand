...
CREATE TABLE `department_group` (
  ...
  CONSTRAINT `fk_department_group_1` FOREIGN KEY (`department_id`) REFERENCES `department` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_department_group_2` FOREIGN KEY (`group_id`) REFERENCES `department` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
...
CREATE TABLE `join_department_message` (
  ...
  CONSTRAINT `fk_join_department_message_1` FOREIGN KEY (`department_id`) REFERENCES `department` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `join_department_user_message` (
  ...
  CONSTRAINT `fk_join_department_user_message_1` FOREIGN KEY (`department_id`) REFERENCES `department` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `join_user_role` (
  ...
  KEY `fk_join_user_role_2_idx` (`role_id`),
  CONSTRAINT `fk_join_user_role_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_join_user_role_2` FOREIGN KEY (`role_id`) REFERENCES `role` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `role` (
  ...
  `permission_1` tinyint(1) DEFAULT '0',
  `permission_2` tinyint(1) DEFAULT '0',
  `permission_3` tinyint(1) DEFAULT '0',
  `permission_4` tinyint(1) DEFAULT '0',
  `permission_5` tinyint(1) DEFAULT '0',
  `permission_6` tinyint(1) DEFAULT '0',
  `permission_7` tinyint(1) DEFAULT '0',
  `permission_8` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`)
...
CREATE TABLE `user` (
  ...
  CONSTRAINT `fk_user_1` FOREIGN KEY (`department_id`) REFERENCES `department` (`id`) ON UPDATE CASCADE
...
-- Dump completed on 2021-07-08 15:17:20
